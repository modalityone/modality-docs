...
=== Create a Run Configuration for the Modality Server
...
=== Create a Run Configuration for the Back-Office Desktop client
...
=== Create a Run Configuration for the Back-Office Web client
NOTE: We use the WebFX CLI to build web clients (described later), so no run configuration necessary.


=== Create a Run Configuration for the Front-Office Mobile client
NOTE: The Front-Office Mobile client is not yet implemented.


=== Create a Run Configuration for the Front-Office Web client
...
=== Build and open the Back-Office Web client
...
=== Build and run the Front-Office Mobile client
NOTE: The Front-Office Mobile client is not yet implemented.


=== Build and open the Front-Office Web client
NOTE: The Front-Office Web client is not yet implemented.
