...
=== 1. Create a Run Configuration for the Modality Server
...
=== 2. Create a Run Configuration for the Modality Back-Office (Desktop) client
...
=== 3. Create a Run Configuration for the Modality Back-Office (Web) client
NOTE: Documentation not yet available.


=== 4. Create a Run Configuration for the Modality Front-Office (Mobile) client
NOTE: Documentation not yet available.


=== 5. Create a Run Configuration for the Modality Front-Office (Web) client
NOTE: Documentation not yet available.
...
=== 1. Ensure Docker is running [red]***
 cd $MODALITY_ROOT/docker
 docker-compose up


=== 2. Start the Modality Server [red]***
Start the Modality server by executing the run configuration:

image::run-modality-server-locally-1.png[]


=== 3. Start the Modality Back-Office (Desktop) client
...
=== 4. Start the Modality Back-Office (Web) client
NOTE: Documentation not yet available.


=== 5. Start the Modality Front-Office (Mobile) client
NOTE: Documentation not yet available.


=== 6. Start the Modality Front-Office (Web) client
NOTE: Documentation not yet available.
