...
<10> wait until the import is complete. Due to the size of the development database, it can take 15+ minutes to import. Modality will not be usable during this time.
