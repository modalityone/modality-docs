...
Modality is the first large-scale Java project to use link:https://docs.webfx.dev[WebFX^] - a toolkit that transpiles JavaFX applications into pure JavaScript web apps for direct execution in the browser.
